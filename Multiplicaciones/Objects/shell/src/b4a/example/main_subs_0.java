...
try {
		Debug.PushSubsStack("btnVolver_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,62);
if (RapidSub.canDelegate("btnvolver_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnvolver_click");}
 BA.debugLineNum = 62;BA.debugLine="Private Sub btnVolver_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 63;BA.debugLine="StartActivity(\"Layout\")";
Debug.ShouldStop(1073741824);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((RemoteObject.createImmutable("Layout"))));
...
try {
		Debug.PushSubsStack("ElegirActividad_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,41);
...
RemoteObject _btnval = RemoteObject.createImmutable((byte)0);
 BA.debugLineNum = 41;BA.debugLine="Private Sub ElegirActividad_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 42;BA.debugLine="Dim btn As Button";
Debug.ShouldStop(512);
_btn = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");Debug.locals.put("btn", _btn);
 BA.debugLineNum = 43;BA.debugLine="Dim btnVal As Byte";
Debug.ShouldStop(1024);
_btnval = RemoteObject.createImmutable((byte)0);Debug.locals.put("btnVal", _btnval);
 BA.debugLineNum = 45;BA.debugLine="btn = Sender";
...
_btn = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("btn", _btn);
 BA.debugLineNum = 46;BA.debugLine="btnVal = btn.Tag";
Debug.ShouldStop(8192);
_btnval = BA.numberCast(byte.class, _btn.runMethod(false,"getTag"));Debug.locals.put("btnVal", _btnval);
 BA.debugLineNum = 49;BA.debugLine="Select btnVal";
Debug.ShouldStop(65536);
switch (BA.switchObjectToInt(_btnval,BA.numberCast(byte.class, 1),BA.numberCast(byte.class, 2),BA.numberCast(byte.class, 3),BA.numberCast(byte.class, 4))) {
case 0: {
 BA.debugLineNum = 51;BA.debugLine="StartActivity(\"Suma1\")";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((RemoteObject.createImmutable("Suma1"))));
 break; }
case 1: {
 break; }
case 2: {
