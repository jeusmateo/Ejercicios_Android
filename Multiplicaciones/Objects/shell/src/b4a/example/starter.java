...
public static b4a.example.tools _tools = null;
  public Object[] GetGlobals() {
		return new Object[] {"Main",Debug.moduleToString(b4a.example.main.class),"Mult",Debug.moduleToString(b4a.example.mult.class),"Service",starter.mostCurrent._service,"Suma1",Debug.moduleToString(b4a.example.suma1.class),"Suma2",Debug.moduleToString(b4a.example.suma2.class),"Tablas",Debug.moduleToString(b4a.example.tablas.class),"Tools",Debug.moduleToString(b4a.example.tools.class)};
}
}