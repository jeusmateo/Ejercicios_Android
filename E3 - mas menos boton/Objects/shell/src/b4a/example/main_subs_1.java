...
Debug.ShouldStop(512);
 BA.debugLineNum = 46;BA.debugLine="num = txtNum.Text";
Debug.ShouldStop(8192);
main._num = BA.numberCast(int.class, main.mostCurrent._txtnum.runMethod(true,"getText"));
 BA.debugLineNum = 48;BA.debugLine="Log(num)";
Debug.ShouldStop(32768);
main.mostCurrent.__c.runVoidMethod ("LogImpl","0851974",BA.NumberToString(main._num),0);
...
try {
		Debug.PushSubsStack("btnSumar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,52);
if (RapidSub.canDelegate("btnsumar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnsumar_click");}
 BA.debugLineNum = 52;BA.debugLine="Private Sub btnSumar_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 53;BA.debugLine="txtNum.Text = txtNum.Text + 1";
