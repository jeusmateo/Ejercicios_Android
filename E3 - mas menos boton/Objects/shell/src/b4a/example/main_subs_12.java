...
main.mostCurrent._txtnum.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(1)}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("btnSumar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,53);
...
main.mostCurrent._txtnum.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(0));
 };
