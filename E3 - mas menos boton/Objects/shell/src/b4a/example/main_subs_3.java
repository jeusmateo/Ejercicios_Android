...
if ((RemoteObject.solveBoolean("=",main.mostCurrent._txtnum.runMethod(true,"getText"),RemoteObject.createImmutable("")))) { 
 BA.debugLineNum = 45;BA.debugLine="txtNum = 1";
Debug.ShouldStop(4096);
main.mostCurrent._txtnum = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.EditTextWrapper"), RemoteObject.createImmutable(1));
 };
